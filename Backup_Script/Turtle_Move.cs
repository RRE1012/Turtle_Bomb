...
public class Turtle_Move : MonoBehaviour {
	...
	void Update () {
        if (Input.GetMouseButton(0))
        {
            ...
            NetworkTest2.instance.SetMyPos(transform.position.x, transform.rotation.y, transform.position.z);
    ...
    public void SetBomb() // 폭탄 설치
    {
        ...
        if (UI.m_bomb_count > 0)
        {
            ...
            if (m_YouCanSetBomb)
            {
                ...
                NetworkTest2.instance.SetBombPos((int)m_BombLocX, (int)m_BombLocZ);
